...
export function TikTokIcon({ size = 18, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M16.6 5.82c-.9-.95-1.4-2.2-1.4-3.5h-3.05v13.36c0 1.5-1.22 2.72-2.72 2.72a2.72 2.72 0 0 1 0-5.44c.28 0 .55.04.8.12V9.9a5.9 5.9 0 0 0-.8-.06A5.87 5.87 0 0 0 3.55 15.7 5.87 5.87 0 0 0 9.43 21.56a5.87 5.87 0 0 0 5.87-5.87V9.01a8.9 8.9 0 0 0 5.2 1.67V7.63c-1.4 0-2.7-.53-3.9-1.81Z" />
    </svg>
  );
}
